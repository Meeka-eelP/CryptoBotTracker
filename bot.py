...
from tracker import get_prices, get_sat

config = dotenv_values(".env")

updater = Updater(token=config["BOT_TOKEN"], use_context=True)  # type: ignore
...
def start(update, context):
    ...
    update.message.reply_text(
        "Hey! Welcome to the Crypto Price Tracker bot. Type /help for a list of commands")
